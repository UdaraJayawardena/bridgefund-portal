...
import { getNextWorkingDate, getPreviousWorkingDate } from 'store/initiation/actions/Holidays';
...
const CustomDatePicker = ({
  ...
  checkHoliday, getNextWorkingDay, getPreviousWorkingDay, displayNotification, readOnly, variant
}) => {
