...
// import { changeCustomerDetails, clearSelectedCustomer } from 'store/loanmanagement/actions/HeaderNavigation';
...
// const getSuggestions = (value, customers) => {
...
//       [name]: newValue
//     }, () => {
//       if (newValue.trim() === '') this.props.clearSelectedCustomer();
//     });
//   };
...
//       this.props.onSearchSelect(customerDetails);
//     }
...
//     if(this.props.selectedCustomer) single = this.props.selectedCustomer;
//     this.setState({
//       single,
...
//   mapStateToProps,
//   mapDispatchToProps
// )(withStyles(styles)(SearchCustomers));
