...
function CategoryDetailedTransactionHeader({ ...props }) {
    ...
    return (
        <TableHead >
            <TableRow>
                <TableCell className={classes.transactionTableCell}>&nbsp;</TableCell>
                ...
                <TableCell className={classes.transactionTableCell} key="description" align="left">
                    DESCRIPTION
                </TableCell>
...
CategoryDetailedTransactionHeader.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(CategoryDetailedTransactionHeader);