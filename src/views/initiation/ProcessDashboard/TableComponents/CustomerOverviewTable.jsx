...
import { Button, TableSortLabel, Chip, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, TablePagination } from '@material-ui/core';
...
import { clearProcessDataList, getProcessDataList } from 'store/initiation/actions/ProcessDashboard.action';
...
class CustomerOverviewTable extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const { classes, searchedProcessDataList, isLoadingProcessDataList, pagination } = this.props;
        const { isOpenMemoDialog, memoData, expandedProcessIndex, openErrorLogDialog, errorLog, orderBy, order } = this.state;
        return (
            <>
                                ...
                                <Table className={classes.table} aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {searchedProcessDataList.length === 0 ?
                                            ...
                                            <TableRow>
                                                <TableCell className={classes.tableCell} align="center" colSpan={12}>
                                            ...
                                            searchedProcessDataList.map((process, index) =>
                                                <React.Fragment>
                                                    <TableRow key={index} onClick={() => { this.handleProcessRowExpanding(index); }}
...
// @ts-ignore
export default connect(mapStateToProp, mapDispatchToProps)(withStyles(style)(CustomerOverviewTable));