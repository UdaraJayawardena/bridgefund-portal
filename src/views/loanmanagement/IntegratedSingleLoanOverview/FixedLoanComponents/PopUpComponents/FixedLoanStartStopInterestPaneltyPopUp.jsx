import { Dialog, DialogTitle, DialogActions, DialogContent, RadioGroup, FormControlLabel, Radio, DialogContentText } from '@material-ui/core';
import Button from 'components/initiation/CustomButtons/Button';
import React, { Component } from 'react';

class FixedLoanStartStopInterestPaneltyPopUp extends Component {
    ...
    render() {
        ...
        return (
            <>
                <Dialog id="start-stop-loan-confirm-drawer" open={open} onClose={() => handleStartStopInterestPaneltyScreen()} aria-labelledby="form-dialog-title">
                    ...
                    <DialogActions>
                        <Button id="start-stop-loan-confirm-drawer-back-button" onClick={() => handleStartStopInterestPaneltyScreen()}>
                            CANCEL
                        </Button>
...
export default FixedLoanStartStopInterestPaneltyPopUp;