...
// Top right section 
class FixedStatusOverview extends Component {
    render() {
...
FixedStatusOverview.propTypes = {
    loanData: PropTypes.object,
};

export default withStyles(customStyles)(FixedStatusOverview);