export const smeLoanStatus = {
  ...
  REVISION_DISAPPROVED: 'revision-disapproved',
  PAUSED: 'paused',
};
...
export const approveRevisionStep = {
   REVISION_ONE: 'approve-flex-loan-revision-01',
   REVISION_TWO: 'approve-flex-loan-revision-02',
   REVISION_THREE: 'approve-flex-loan-revision-03'
};

export const approveRevisionRoles ={
...
export const getPlannedDDCount = (DDfrequency, durantionInMonths) => {
  console.log(plannedDD[DDfrequency][durantionInMonths]);
  console.log(plannedDD[DDfrequency].indexOf(plannedDD[DDfrequency][durantionInMonths]));
